...
'''
Compare training losses of different models against each other
--combine sets : units training loss from training set with training loss 
form validation set.
Training logs contain four columns, training loss for A) training set, B) validation set, and validation loss for A) training set and B) validation set
TODO
make the individual subplots a function, potentially the entire figure another function
'''
